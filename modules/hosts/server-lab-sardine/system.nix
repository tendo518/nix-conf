...
{ lib, ... }:
{
  flake.modules.nixos."hosts/server-lab-sardine/system" = _: {
    # Reuse system/base for its journald/nscd/no-file/limit defaults.  nix-ld
    # is opt-in through system/nix-ld and is intentionally absent here.
